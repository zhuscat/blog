...
export default ({ data }) => {
  ...
  return (
    <div>
      ...
      <div>{post.frontmatter.tags && post.frontmatter.tags.map(name => <Tag key={name} name={name} />)}</div>
      <div
        style={{
          marginTop: '32px',
          marginBottom: '32px',
      ...
      >
        ...
        <br />
        本作品采用<a rel="license" href="http://creativecommons.org/licenses/by-nc-nd/4.0/">
